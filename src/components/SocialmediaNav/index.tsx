...
const SocialmediaNav = () => {
  return (
    <nav className={Style.social__media}>
      ...
      <Link
        to="#"
        className={`${Style.social__link} ${Style.social__discord}`}
        title="jgregori canal de discord"
      >
      <svg xmlns="http://www.w3.org/2000/svg" className="social__discord icon icon-tabler icon-tabler-brand-discord-filled" width="32" height="32" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
